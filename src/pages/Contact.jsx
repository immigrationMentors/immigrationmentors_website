      ...
      <section className="py-6 sm:py-8 md:py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-base sm:text-md md:text-lg text-gray-600 max-w-3xl mx-auto font-semibold">
            Ready to start your immigration journey? Get in touch with us.
          </p>
        </div>
      </section>
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm sm:text-base break-all">info@immigrationmentors.in</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm sm:text-base">19-2-227/1/A/1, Bahadurpura<br />Hyderabad, 500064<br />Telangana, India</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card p-2 sm:p-4 md:p-6">
                ...
                <div className="rounded-lg overflow-hidden h-50 sm:h-64 md:h-76">
                  <iframe
                    ...
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d952.0429481976347!2d78.45389626961877!3d17.355464598970407!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb9752d41a32ef%3A0xbfb131f966f1dd11!2sImmigration%20Mentors!5e0!3m2!1sen!2sca!4v1772626764985!5m2!1sen!2sca"
                  ></iframe>
                </div>
              </div>
            </div>
