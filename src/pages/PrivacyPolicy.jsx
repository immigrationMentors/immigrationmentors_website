    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-6 sm:py-8 md:py-10 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-3 sm:mb-4 md:mb-6">Privacy Policy</h1>
      ...
      <div className="py-8 sm:py-10 md:py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose max-w-none text-gray-700">
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">1. Information We Collect</h2>
            <p className="mb-3 sm:mb-4">We may collect the following categories of information:</p>
            
            <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mt-4 sm:mt-6 mb-2 sm:mb-3">a) Personal Information (provided voluntarily)</h3>
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mt-4 sm:mt-6 mb-2 sm:mb-3">b) Website & Technical Data (collected automatically)</h3>
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">2. Purpose of Data Collection</h2>
            <p className="mb-3 sm:mb-4">We collect and process personal data to:</p>
            <ul className="list-disc pl-4 sm:pl-6 mb-4 sm:mb-6 space-y-1 sm:space-y-2">
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">3. Legal Basis for Processing</h2>
            <p className="mb-3 sm:mb-4">We process data under the following legal bases:</p>
            <ul className="list-disc pl-4 sm:pl-6 mb-4 sm:mb-6 space-y-1 sm:space-y-2">
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">4. Data Sharing & Disclosure</h2>
            <p className="mb-3 sm:mb-4">We may share your data with:</p>
            <ul className="list-disc pl-4 sm:pl-6 mb-3 sm:mb-4 space-y-1 sm:space-y-2">
            ...
            <p className="mb-4 sm:mb-6">We do not sell, rent, or trade your personal data to unauthorized third parties.</p>

            <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">5. Data Storage & Security</h2>
            <p className="mb-3 sm:mb-4">We adopt reasonable technical and organizational measures to protect personal information, including:</p>
            <ul className="list-disc pl-4 sm:pl-6 mb-3 sm:mb-4 space-y-1 sm:space-y-2">
            ...
            <p className="mb-4 sm:mb-6">We retain your personal data only as long as necessary for service delivery or as required by law.</p>

            <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">6. Cookies & Tracking Technologies</h2>
            <p className="mb-3 sm:mb-4">Our website may use cookies and tracking tools to:</p>
            <ul className="list-disc pl-4 sm:pl-6 mb-3 sm:mb-4 space-y-1 sm:space-y-2">
              <li>Improve website performance and user experience</li>
              <li>Analyze traffic and usage patterns</li>
              <li>Personalize content and services</li>
            </ul>
            <p className="mb-4 sm:mb-6">You can disable cookies through your browser settings. However, this may limit website functionality.</p>

            <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">7. International Data Transfers</h2>
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">8. Your Rights</h2>
            <p className="mb-3 sm:mb-4">Depending on applicable laws (e.g., Indian DPDP Act 2023, GDPR), you may have the following rights:</p>
            <ul className="list-disc pl-4 sm:pl-6 mb-3 sm:mb-4 space-y-1 sm:space-y-2">
            ...
            <p className="mb-4 sm:mb-6">To exercise your rights, please email us at info.immigrationmentors@gmail.com.</p>

            <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">9. Third-Party Links</h2>
            <p className="mb-4 sm:mb-6">
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">10. Updates to Privacy Policy</h2>
            <p className="mb-4 sm:mb-6">
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">11. Contact Us</h2>
            <p className="mb-3 sm:mb-4">If you have any questions, concerns, or requests related to this Privacy Policy, please contact us at:</p>
