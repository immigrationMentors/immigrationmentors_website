    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-6 sm:py-8 md:py-10 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-600 max-w-3xl mx-auto font-semibold">
            Your trusted partner in making global dreams a reality.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div>
              ...
              <p className="text-base sm:text-base md:text-lg text-gray-700 mb-4 sm:mb-6 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-6 text-sm sm:text-base text-gray-600">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-4 sm:p-6 md:p-8 rounded-2xl">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-gray-900 mb-1 sm:mb-2 text-base sm:text-lg">Trust</h4>
                  <p className="text-gray-600 text-sm sm:text-base">Building lasting relationships through honesty and reliability</p>
                </div>
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-gray-900 mb-1 sm:mb-2 text-base sm:text-lg">Integrity</h4>
                  <p className="text-gray-600 text-sm sm:text-base">Ethical practices and transparent communication at every step</p>
                </div>
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-gray-900 mb-1 sm:mb-2 text-base sm:text-lg">Excellence</h4>
                  <p className="text-gray-600 text-sm sm:text-base">Delivering quality service with attention to detail</p>
                </div>
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-gray-900 mb-1 sm:mb-2 text-base sm:text-lg">Support</h4>
                  <p className="text-gray-600 text-sm sm:text-base">Committed guidance throughout your immigration journey</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="text-center p-4 sm:p-6">
              ...
              <h3 className="font-semibold text-base sm:text-lg md:text-xl mb-2 sm:mb-3">Experienced Professionals</h3>
              <p className="text-gray-600 text-sm sm:text-base md:text-base">A dedicated team with in-depth knowledge of global visa and immigration systems.</p>
            </div>
            ...
            <div className="text-center p-4 sm:p-6">
              ...
              <h3 className="font-semibold text-base sm:text-lg md:text-xl mb-2 sm:mb-3">Personalized Guidance</h3>
              <p className="text-gray-600 text-sm sm:text-base md:text-base">Tailored solutions to match your unique goals, background, and career plans.</p>
            </div>
            ...
            <div className="text-center p-4 sm:p-6">
              ...
              <h3 className="font-semibold text-base sm:text-lg md:text-xl mb-2 sm:mb-3">Proven Track Record</h3>
              <p className="text-gray-600 text-sm sm:text-base md:text-base">High success rate in securing student visas, work permits, and permanent residency approvals.</p>
            </div>
            ...
            <div className="text-center p-4 sm:p-6">
              ...
              <h3 className="font-semibold text-base sm:text-lg md:text-xl mb-2 sm:mb-3">End-to-End Support</h3>
              <p className="text-gray-600 text-sm sm:text-base md:text-base">From course selection to visa stamping, and pre-departure guidance — we're with you all the way.</p>
            </div>
          </div>
        </div>
      </section>
