    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-6 sm:py-8 md:py-10 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4 md:mb-6">Terms & Conditions</h1>
      ...
      <div className="py-8 sm:py-10 md:py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose max-w-none text-gray-700">
            ...
            <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">1. General Information</h2>
            ...
            <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">2. Use of Website & Services</h2>
            <ul className="list-disc pl-4 sm:pl-6 mb-4 sm:mb-6 space-y-1 sm:space-y-2 text-sm sm:text-base md:text-md">
            ...
            <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">3. Client Responsibilities</h2>
            <p className="text-sm sm:text-base md:text-md mb-3 sm:mb-4">By engaging our services, you agree to:</p>
            <ul className="list-disc pl-4 sm:pl-6 mb-4 sm:mb-6 space-y-1 sm:space-y-2 text-sm sm:text-base md:text-md">
            ...
            <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">4. Consultancy Scope & Limitations</h2>
            ...
            <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">5. Fees & Payments</h2>
            <ul className="list-disc pl-4 sm:pl-6 mb-4 sm:mb-6 space-y-1 sm:space-y-2 text-sm sm:text-base md:text-md">
            ...
            <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">6. Data Privacy & Consent</h2>
            <ul className="list-disc pl-4 sm:pl-6 mb-4 sm:mb-6 space-y-1 sm:space-y-2 text-sm sm:text-base md:text-md">
            ...
            <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">7. Intellectual Property</h2>
            <ul className="list-disc pl-4 sm:pl-6 mb-4 sm:mb-6 space-y-1 sm:space-y-2 text-sm sm:text-base md:text-md">
            ...
            <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">8. Third-Party Links</h2>
            <ul className="list-disc pl-4 sm:pl-6 mb-4 sm:mb-6 space-y-1 sm:space-y-2 text-sm sm:text-base md:text-md">
            ...
            <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">9. Limitation of Liability</h2>
            <p className="text-sm sm:text-base md:text-md mb-3 sm:mb-4">Immigration Mentors will not be held liable for:</p>
            <ul className="list-disc pl-4 sm:pl-6 mb-3 sm:mb-4 space-y-1 sm:space-y-2 text-sm sm:text-base md:text-md">
            ...
            <p className="text-sm sm:text-base md:text-md mb-4 sm:mb-6">Our liability is limited to the extent of the consultancy fees paid to us.</p>

            <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">10. Termination of Services</h2>
            <p className="text-sm sm:text-base md:text-md mb-3 sm:mb-4">Immigration Mentors reserves the right to terminate services if:</p>
            <ul className="list-disc pl-4 sm:pl-6 mb-4 sm:mb-6 space-y-1 sm:space-y-2 text-sm sm:text-base md:text-md">
            ...
            <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">11. Governing Law</h2>
            <ul className="list-disc pl-4 sm:pl-6 mb-4 sm:mb-6 space-y-1 sm:space-y-2 text-sm sm:text-base md:text-md">
            ...
            <h2 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mt-6 sm:mt-8 mb-3 sm:mb-4">12. Contact Us</h2>
            <p className="text-sm sm:text-base md:text-md mb-3 sm:mb-4">If you have any questions about these Terms & Conditions, please contact us:</p>
            <div className="bg-gray-100 p-3 sm:p-4 rounded-lg text-sm sm:text-base md:text-md">
              ...
              <div>
                ...
                <p className="ml-6">19-2-227/1/A/1, Bahadurpura<br />Hyderabad, 500064<br />Telangana, India</p>
              </div>
            </div>
          </div>
        </div>
