        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8 md:gap-12">
          ...
          <div className="mt-4 sm:mt-0">
            ...
            <ul className="space-y-1 md:space-y-2">
              <li><Link to="/country/canada" className="text-gray-300 hover:text-white transition-colors text-sm sm:text-base md:text-md">Canada</Link></li>
              <li><Link to="/country/usa" className="text-gray-300 hover:text-white transition-colors text-sm sm:text-base md:text-md">United States</Link></li>
              <li><Link to="/country/uk" className="text-gray-300 hover:text-white transition-colors text-sm sm:text-base md:text-md">United Kingdom</Link></li>
              <li><Link to="/country/australia" className="text-gray-300 hover:text-white transition-colors text-sm sm:text-base md:text-md">Australia</Link></li>
            </ul>
